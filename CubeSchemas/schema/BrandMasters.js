cube(`BrandMasters`, {
  sql: `SELECT * FROM ebdb.brand_masters`,
  ...
  joins: {
    ...
    BrandCategoryMasters: {
      sql: `${CUBE}.brand_category_master_id = ${BrandCategoryMasters}.id`,
      relationship: `belongsTo`
    },
    
    ManufacturerMasters: {
      sql: `${CUBE}.manufacturer_master_id = ${ManufacturerMasters}.id`,
      relationship: `belongsTo`
    }
  },
  ...
  measures: {
    count: {
      type: `count`,
      drillMembers: [id, brandName, vaccineMasterIds, createdAt, updatedAt]
    },
