cube(`PatientEarnedIncentiveDetails`, {
  sql: `SELECT * FROM ebdb.patient_earned_incentive_details`,
  ...
  joins: {
    ...
    IncentiveTypeMasters: {
      sql: `${CUBE}.incentive_type_master_id = ${IncentiveTypeMasters}.id`,
      relationship: `belongsTo`
    },
