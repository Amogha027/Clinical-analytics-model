cube(`TempDoctorVisits`, {
  sql: `SELECT * FROM ebdb.temp_doctor_visits`,
  ...
  measures: {
    count: {
      type: `count`,
      drillMembers: [id, updatesJson, icdCodeMasterId, comorbidity, createdAt, procUpdatedAt, updatedAt, visitDate]
    },
